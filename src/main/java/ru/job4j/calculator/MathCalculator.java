...
public class MathCalculator {
    ...
    public static double sumSumAndMultiplyAndSubtractAndDivide(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + sumSumAndMultiplyAndSubtractAndDivide(10, 20));
